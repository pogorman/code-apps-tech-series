...
This Code App provides a CRM-style interface for managing accounts and contacts stored in Dataverse. Navigate between views using the sidebar.
...
The Contacts page shows a searchable table with columns: Name, Account, Email, Job Title, and Actions. Click any row to open the contact detail card.
