...
3. If `docs/tracked/` doesn't exist, create it (and `docs/tracked/pdf/`).
...
1. **PDF generation — only if the `pdf` flag is present:**
   ...
   - If available, run `npx md-to-pdf <path-to-doc> --dest docs/tracked/pdf/` to generate a PDF in the pdf subfolder
