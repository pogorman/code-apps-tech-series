...
1. Check `docs/tracked/` for existing `tracked*.md` files. Create `docs/tracked/` (and `docs/tracked/pdf/`) if they don't exist.
...
1. Create `docs/tracked/` (and `docs/tracked/pdf/`) if they don't exist.
