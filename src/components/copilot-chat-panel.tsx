...
const AGENT_SCHEMA_NAME = "cr6bd_agentDVkdZi";
  ...
  return (
    <>
      <button
        ...
        className={cn(
          "fixed bottom-6 right-[5.5rem] z-50 flex h-12 w-12 items-center justify-center rounded-full shadow-lg transition-transform hover:scale-110",
